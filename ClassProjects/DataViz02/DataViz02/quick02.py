...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "DataViz02.settings")
...
# -----------------------------------------------------------
    ...
    sidebar.write(
        """
        This is the first attempt to learn StreamLit
        """
    )
    # -----------------------------------------------------------
    ...
    """
    An illustration for the Streamlit introduction in Information System Development.
    """
